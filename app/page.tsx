          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full px-2">
            ...
            <WobbleCard containerClassName="col-span-1 lg:col-span-3 bg-blue-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
              <div className="max-w-sm">
                ...
                <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
                  Whether you're new to investing or a seasoned pro, our educational resources will help you navigate the world of startup investments. From understanding market trends to learning how to evaluate startups, we provide the tools you need to invest with confidence.
                </p>
              </div>
              <Image
                src="/bounty.png"
